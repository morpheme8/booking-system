...
@ComponentScan(basePackages = "pl.morpheme.bookingsystem.configuration")
...
public class HibernateConfiguration extends WebMvcConfigurerAdapter {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] { "pl.morpheme.bookingsystem.domain" });
    ...
    private Properties hibernateProperties() {
       ...
       // properties.put("hibernate.connection.isolation", environment.getRequiredProperty("hibernate.connection.isolation"));
